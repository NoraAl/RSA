...
/*this constructor is added to the library to build a BigInteger with specific size
and sign. The value of this BigInteger is the least that can be represented in the "lengthInBits"
*/
BigInteger::BigInteger(int lengthInBits, Sign sign, bool trueIfOdd) : mag(0)
{
    this->sign = sign;
    mag.setBit( lengthInBits-1 , true);//2^lengthInBits
    mag.setBit(0, trueIfOdd);//2^lengthInBits +1
}
